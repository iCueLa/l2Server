...
public final class Util
{
    ...
    public static void handleIllegalPlayerAction(final Player actor, final String message, final int punishment) {
        ThreadPool.schedule(new IllegalPlayerAction(actor, message, punishment), 5000L);
    }
