...
public final class CharacterKillingManager
{
	...
	{	
		...
		long millisToNextCycle = (_cycleStart + CustomConfig.CKM_CYCLE_LENGTH) - System.currentTimeMillis();
	...
	public synchronized void newKillingCycle()
	{
		...
		_scheduledKillingCycleTask = ThreadPool.schedule(new CharacterKillingCycleTask(), CustomConfig.CKM_CYCLE_LENGTH);
	}
	...
	private void broadcastPvPMorphUpdate(PcPolymorph npc, CharSelectSlot winnerPvPKillsInfo)
	{
		...
		npc.setVisibleTitle(CustomConfig.CKM_PVP_NPC_TITLE.replaceAll("%kills%", String.valueOf(_winnerPvPKillsCount)));
		npc.setTitleColor(CustomConfig.CKM_PVP_NPC_TITLE_COLOR);
		npc.setNameColor(CustomConfig.CKM_PVP_NPC_NAME_COLOR);
	...
	private void broadcastPKMorphUpdate(PcPolymorph npc, CharSelectSlot winnerPKKillsInfo)
	{
		...
		npc.setVisibleTitle(CustomConfig.CKM_PK_NPC_TITLE.replaceAll("%kills%", String.valueOf(_winnerPKKillsCount)));
		npc.setTitleColor(CustomConfig.CKM_PK_NPC_TITLE_COLOR);
		npc.setNameColor(CustomConfig.CKM_PK_NPC_NAME_COLOR);
	...
	private static void addReward(int obj_id, boolean duple)
	{
		...
		for (IntIntHolder reward : CustomConfig.MONUMENT_EVENT_REWARDS)
		{
