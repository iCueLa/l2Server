...
{
	private static final Logger _log = Logger.getLogger(Topzone.class.getName());
       ...
       public int getVotes()
       {
    	   	   int votes = -1;
               try {
       			final URL obj = new URL(String.format("http://l2topzone.com/tv.php?id=%s", CustomConfig.TOPZONE_SERVER_ID));
