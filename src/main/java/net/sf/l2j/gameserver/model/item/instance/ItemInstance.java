...
public final class ItemInstance extends WorldObject implements Runnable, Comparable<ItemInstance>
{
	...
	private static final long RAID_LOOT_PROTECTION_TIME = 30000;  //custom drop from rb can be taken after 30sec (default: 300000 is too much)
	...
	public class ItemDropTask implements Runnable
	{
		...
		public final void run()
		{
			...
			//custom instances
			_itm.setInstance(getInstance(), false);
	...
	public static ItemInstance create(int itemId, int count, Player actor, WorldObject reference)
	{
		...
		}while(AutobotsDao.INSTANCE.itemExist(id));

		// Create and Init the ItemInstance corresponding to the Item Identifier
		ItemInstance item = new ItemInstance(id, itemId);//IdFactory.getInstance().getNextId()
	...
	{
		//custom unlimited ss and unlimited pot
