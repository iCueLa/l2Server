...
public class WeddingManagerNpc extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("GoToLove"))
		{
			...
			//custom added if partner is in town only teleport to him
			if (partner.isInTournament() || !partner.isInsideZone(ZoneId.TOWN) || partner.isInJail() || partner.isInOlympiadMode() || partner.isInDuel() || partner.isFestivalParticipant() || (partner.isInParty() && partner.getParty().isInDimensionalRift()) || partner.isInObserverMode())
			{
