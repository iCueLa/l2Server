...
//	INSERT INTO `clan_privs_test` (`clan_id`,`rank`,`privs`) VALUES (1,1,1) ON DUPLICATE KEY UPDATE `privs` = VALUES(`privs`)
	...
	public boolean levelUpClan(Player player)
	{
		...
		switch (_level)
		{
			...
			case 5:
				if (_reputationScore >= 10000 && getMembersCount() >= 30) //custom , default: 30
				{
			...
			case 6:
				if (_reputationScore >= 20000 && getMembersCount() >= 50) //custom , default: 80
				{
			...
			case 7:
				if (_reputationScore >= 40000 && getMembersCount() >= 60)//custom , default: 120
				{
