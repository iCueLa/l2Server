...
//		DecayTaskManager.getInstance().add(this, 1200);
		//Custom 2min for res pet
		getOwner().sendMessage("Your pet has been killed! Make sure you resurrect your pet within 2 minutes or your pet and all of it's items will disappear forever!");
		DecayTaskManager.getInstance().add(this, 120);
