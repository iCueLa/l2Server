...
public class Attackable extends Npc
{
	...
	public boolean doDie(Creature killer)
	{
		...
		if(killer != null) {
			...
			if(player != null) {
				VipDropManager.addReward(player, this);
			}
		}
	...
	/*	if (getSpawn() != null && !isInsideRadius(getSpawn().getLocX(), getSpawn().getLocY(), CustomConfig.RB_RETURN_SPAWN_RAD, false))
		{
			
			if(CustomConfig.RAID_INFO_IDS_LIST.contains(getNpcId()))
				teleportTo(getSpawn().getLoc(), 0);
