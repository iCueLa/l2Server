	...
	*/
	...
	//custom for balancer
		...
		public int getBaseRunSpeed()
		{
			...
			int val =  super.getBaseRunSpeed();
			if (getActiveChar().getClassId().getId() >= 88)
				val += BalanceLoad.Speed[getActiveChar().getClassId().getId() - 88];
...
/*	@Override
	...
	*/
	...
	public int getMAtk(Creature target, L2Skill skill)
	{
		...
		if (getActiveChar().getClassId().getId() >= 88)
			val += BalanceLoad.MAtk[getActiveChar().getClassId().getId() - 88];
	...
	public int getMAtkSpd()
	{
		...
		if (getActiveChar().getClassId().getId() >= 88)
			val += BalanceLoad.MAtkSpd[getActiveChar().getClassId().getId() - 88];
	...
	public int getPAtk(Creature target)
	{
		...
		if (getActiveChar().getClassId().getId() >= 88)
			val += BalanceLoad.PAtk[getActiveChar().getClassId().getId() - 88];
	...
	public int getPAtkSpd()
	{
		...
		if (getActiveChar().getClassId().getId() >= 88)
			val += BalanceLoad.PAtkSpd[getActiveChar().getClassId().getId() - 88];
