...
public class CharEffectList
{
	...
	private List<L2Effect> _augments;
	...
	public final void stopAllEffects()
	{
		...
		{
			if (e != null && !e.getSkill().isVoteBuff() )
				e.exit(true);
		}
	}
	...
	public final void stopAllEffectsExceptThoseThatLastThroughDeath()
	{
		...
		// Exit them
		//custom vote buff not exist
		for (L2Effect e : effects)
		{
			if (e != null && !e.getSkill().isStayAfterDeath() && !e.getSkill().isVoteBuff() && !e.getSkill().isBossScroll() )  //custom vote , Boss scrolls not removed on die
				e.exit(true);
		}
	}
