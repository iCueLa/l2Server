...
public class Escape implements IUserCommandHandler
{
	...
	{
		//custom events
        if (!CTFEvent.onEscapeUse(activeChar.getObjectId()) || !DMEvent.onEscapeUse(activeChar.getObjectId()) /*|| !LMEvent.onEscapeUse(activeChar.getObjectId())*/ || !TvTEvent.onEscapeUse(activeChar.getObjectId()) || activeChar.isCastingNow() || activeChar.isSitting() || activeChar.isMovementDisabled() || activeChar.isOutOfControl() || activeChar.isInOlympiadMode() || activeChar.isInObserverMode() || activeChar.isFestivalParticipant() || activeChar.isInJail()) {
