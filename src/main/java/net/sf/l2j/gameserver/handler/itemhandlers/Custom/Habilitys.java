...
public class Habilitys implements IItemHandler
{
	protected static final Logger _log = Logger.getLogger(Habilitys.class.getName());
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
	{
		...
		if (skills == null)
		{
			_log.info("{} doesn't have any registered skill for handler. " + item.getName());
			return;
		}
