...
public class AdminSkill implements IAdminCommandHandler
{
	...
	private static void adminRemoveSkill(Player activeChar, int idval)
	{
		...
		{
			activeChar.sendMessage("You removed the skill " + skill.getName() + " id: " + skill.getId() + " from " + player.getName() + ".");
			if (player != activeChar)
				player.sendMessage("Admin removed the skill " + skill.getName() + " id: " + skill.getId() + " from your skills list.");
