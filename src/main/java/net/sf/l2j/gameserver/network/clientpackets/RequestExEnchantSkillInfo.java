...
public final class RequestExEnchantSkillInfo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(folk.getNpcId() == CustomConfig.DONATE_NPC){
			int level = _skillLevel < 140 ? 112 : 152;
			ExEnchantSkillInfo esi = new ExEnchantSkillInfo(_skillId, level,0,0, 100);
			esi.addRequirement(4, CustomConfig.DONATE_ITEM, CustomConfig.DONATION_SKILL_ENCH_COUNT, 0);
			sendPacket(esi);
