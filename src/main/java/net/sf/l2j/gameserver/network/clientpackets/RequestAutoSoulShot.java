				...
				if (_itemId < 6535 || _itemId > 6540)
				{
					...
					if (_itemId == 6645 || _itemId == 6646 || _itemId == 6647)
					{
						if (activeChar.getSummon() != null)
						{
							...
							if (_itemId == 6645)
							{
								if (activeChar.getSummon().getSoulShotsPerHit() > item.getCount() && !item.getItem().isInfinity())
								{
							...
							{
								if (activeChar.getSummon().getSpiritShotsPerHit() > item.getCount() && !item.getItem().isInfinity())
								{
